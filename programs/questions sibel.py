...
def two(input):
    ...
    if input.count("bert") == 2:
        result = input[input.find(find)+len(find):input.rfind(find)]
        return result
    else:
        return ""
...
#def four(arg1):
   #seperated = arg1.split()
   #for i in  range(seperated):
...
def nine(inputString, char):
    if char in inputString:
        ...
        return -1
    #keeps returning 3 instead of 4
